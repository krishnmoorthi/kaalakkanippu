...
var planetChart = ['sun', 'moon', 'guru', 'rhagu', 'budhan', 'sukran', 'kethu', 'shani', 'sevvaai'];
var friendPlanets = {
...
function matchPlanetsForRelation(planet, namePlanet, relation) {
  ...
  for (i = 0; i < planetsArray.length; i++) {
    var planetArr = planetsArray[i].toUpperCase();
    var nameMatch = namePlanet.toUpperCase();
